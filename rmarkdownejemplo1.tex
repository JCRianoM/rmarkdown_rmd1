...
\hypersetup{
  pdftitle={Modulo2\_rmarkdown\_ejemplo1},
...
\title{Modulo2\_rmarkdown\_ejemplo1}
...
install.packages(`tinytex') library(tinytex) tinytex::tlmgr\_update()
...
\hypertarget{nivel-tres}{%
\subsubsection{nivel tres}\label{nivel-tres}}
...
\includegraphics{rmarkdownejemplo1_files/figure-latex/pressure-1.pdf}

\includegraphics{rmarkdownejemplo1_files/figure-latex/presure-1.pdf}

\hypertarget{insertando-tablas}{%
\subsection{Insertando tablas}\label{insertando-tablas}}

Usar la función kable de knitr

\begin{longtable}[]{@{}rr@{}}
\caption{Esto corresponde a las 6 primeras filas de la base de datos
cars}\tabularnewline
\toprule
...
8 & 16\tabularnewline
9 & 10\tabularnewline
\#\# Inser & tando una ecuación.\tabularnewline
\# Ecuaci & ón de regresión lineal simple.\tabularnewline
\bottomrule
\end{longtable}
...
\begin{figure}
\centering
\includegraphics{sunstar.mp4}
\caption{sunstarVideo}
\end{figure}

\#\#Insertando texto con notas al pie de página

Acá vamos a insertar una nota al pie de página \footnote{Esta es la
  forma sencilla pero ineficiente.} para dedicar buenas actividades
\footnote{Esta forma es importante pero es más larga, mejor usar en el
  texto únicamente el simbolo \^{}.} Esto es importante para la mayor
parte de los documentos que se requieran \footnote{Este requerimiento
  depende del trabajo que se esté realizando por ejemplo si el caso es
  un documento de texto para una actividad de trabajo o para presentar
